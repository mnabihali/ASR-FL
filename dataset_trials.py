...
def load_datasets():
  trainloaders = []
  devloaders = []
  train_list = [100, 101, 102, 103, 104, 107, 110, 111, 112, 114, 115, 118, 119, 122, 123, 125, 126, 127, 128, 133, 14, 147]
  ...
  for i in range (len(train_list)):
      ...
      tr_spk_pth = '/home/mnabih/another/data/LibriSpeech/train/{}/'.format(x)
  
      print('train path', tr_spk_pth)
  
      dev_spk_pth = '/home/mnabih/another/data/LibriSpeech/dev-clean/{}/'.format(y)
  
      print('dev path', dev_spk_pth)


      train_dataset = LIBRISPEECH("/home/mnabih/another/data/", url=URL, download=False, speaker_federated=tr_spk_pth)
      
      dev_dataset = LIBRISPEECH("/home/mnabih/another/data/", url=URL_TS, download=False, speaker_federated=dev_spk_pth)
      
      trainloaders.append(DataLoader(train_dataset, batch_size=2, shuffle=True, collate_fn=collate_fn, num_workers=0))
      devloaders.append(DataLoader(dev_dataset, batch_size=1, shuffle = False, collate_fn=collate_infer_fn, num_workers=0))
      
  trgl_spk_pth = '/home/mnabih/another/data/LibriSpeech/train/9999/'
  #print('trgl path', trgl_spk_pth)
  traingl_dataset = LIBRISPEECH("/home/mnabih/another/data/", url=URL, download=False, speaker_federated=trgl_spk_pth)
  trainloader_gl = DataLoader(traingl_dataset, batch_size=2, shuffle=True, collate_fn=collate_fn, num_workers=0)
      
  test_dataset = torchaudio.datasets.LIBRISPEECH("/home/mnabih/another/data/", url="test-clean", download=False)
  ...
  print('devloaders', len(devloaders))
...
trainloaders, devloaders, trainloader_gl, testloader = load_datasets()
'''  
